...
const CONFIRMED_ROTATION = (()=>{
  const sets=[
    ...
    {id:"교외선 순환 1(하행 반시계)", seq:["4401","4403","4405","4407","4409","4411","4413","4415","4417","4419","4421","4423","4425","4427","4429","4431","4433","4435"]},
    {id:"교외선 순환 2(상행 시계)", seq:["4402","4404","4406","4408","4410","4412","4414","4416","4418","4420","4422","4424","4426","4428","4430","4432","4434","4436"]},
    {id:"잠실-간성 SRT", seq:["681","682","683","684","685","686","687","688","689","690"]},
    {id:"잠실-봉화 SRT", seq:["691","692","693","694","695","696","697","698","699","700"]},
    {id:"잠실-목포 SRT 1", seq:["801","802","805","806","809","810","813","814","817","818"]},
...
const MAP_LINES = {
  boeun: {name:"보은선",color:"#14b8a6",routes:[{color:"#14b8a6",stations:[{n:"문의",x:318,y:440},{n:"회인",x:342,y:448},{n:"수한",x:365,y:451},{n:"보은",x:370,y:451},{n:"장안",x:385,y:455},{n:"속리산",x:404,y:461},{n:"화남",x:413,y:460},{n:"화령",x:423,y:461},{n:"낙서",x:440,y:473},{n:"서상주",x:466,y:469},{n:"상주",x:474,y:469}]}]},
  gyowe: {name:"교외선",color:"#c026d3",routes:[{color:"#c026d3",stations:[{n:"서울",x:198,y:124},{n:"남금호",x:210,y:120},{n:"청량리",x:216,y:117},{n:"의정부",x:216,y:71},{n:"가능",x:216,y:68},{n:"송추",x:200,y:76},{n:"장흥",x:195,y:77},{n:"고양",x:164,y:98},{n:"관산",x:170,y:94},{n:"주교",x:168,y:94},{n:"행신",x:164,y:108},{n:"서울",x:198,y:124}]}]},
