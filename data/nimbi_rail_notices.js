...
<strong>■ 기존 열차와의 운행 간격을 다시 조정했습니다</strong><br>
새 열차가 기존 열차와 같은 시각에 겹쳐 운행하지 않도록 시간표를 재조정했습니다. 같은 선로에서 나란히 운행하는 열차는 <strong>기본 3분 이상의 간격</strong>을 확보하고, 빠른 열차가 앞 열차를 지나가는 경우에는 역에서 안전하게 순서가 바뀌도록 검증했습니다.<br><br>
<div class="n-box">
예: 목포→남대구 #1453은 15:27 출발, 목포→부산 #1503은 15:30 출발로 조정되어 목포~남대구 구간을 3분 간격으로 운행합니다.<br><br>
