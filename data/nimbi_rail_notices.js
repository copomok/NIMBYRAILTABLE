...
모든 편성의 착발역 연결·회차 여유가 재검증되었습니다.`
  },
  {
    date:'2026-07-20',
    cat:'update',
    title:'지연 열차의 회복 과정을 더 자세히 안내합니다',
    body:`지연 운행 중인 열차가 정차시간을 줄여 지연을 만회하는 과정이 <strong>탑승 여정</strong>에 더 자주, 더 알기 쉽게 반영됩니다.<br><br>
...
<span class="n-warn" style="display:block">정차시간 단축은 승하차 상황과 운행 여건에 따라 적용되지 않을 수 있습니다. 운행 전·운행 중 지연 예상과 도착 시각은 계속 달라질 수 있으니, 탑승 전 최신 정보를 확인해 주세요.</span>`
  }
];
