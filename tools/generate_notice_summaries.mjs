...
const CONFIGS = [
  ...
  {
    id: '20260909-north-trial-summary',
    noticeTitle: '북한 지역 철도 시범 운행 시간표 안내',
    title: '북한 지역 철도 시범 운행계획',
    subtitle: '인게임 운행자료 기반 · 12개 계통·총 246편',
    tables: [manualTable('시범 운행 계통', ['열차 등급', '운행 계통', '열차번호', '운행 횟수'], [
      ['무궁화호', '평양 ↔ 원산', '#3001~#3024', '12회 왕복'],
      ['무궁화호', '서울 ↔ 양구 ↔ 원산', '#3501~#3528', '14회 왕복'],
      ['KTX-산천', '서울 ↔ 블라디보스토크', '#8001~#8012', '6회 왕복'],
      ['KTX-산천', '신의주 ↔ 서울', '#9001~#9036', '18회 왕복'],
      ['KTX-이음', '평양 ↔ 개성(해주 경유)', '#9051~#9078', '14회 왕복'],
      ['KTX-이음', '샘물동 ↔ 평양', '#9101~#9114', '7회 왕복'],
      ['KTX-이음', '원산 ↔ 부산', '#9521~#9540', '10회 왕복'],
      ['KTX-이음', '원산 ↔ 마포', '#9551~#9576', '13회 왕복'],
      ['KTX-이음', '혜산 ↔ 원산', '#9581~#9594', '7회 왕복'],
      ['KTX-이음', '무산 ↔ 원산', '#9601~#9614', '7회 왕복'],
      ['KTX-산천', '경흥 ↔ 남대구', '#9701~#9716', '8회 왕복'],
      ['KTX-산천', '경흥 ↔ 목포', '#9751~#9764', '7회 왕복']
    ])],
    callouts: [
      '현재 시간표는 시범 운행용이며 정식 운행 시간표 확정 시 달라질 수 있습니다.',
