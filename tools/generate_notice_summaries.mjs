...
const CONFIGS = [
  ...
  {
    id: '20260911-north-formal-summary',
    noticeTitle: '북한 지역 철도 정식 운행 시간표 개편',
    title: '북한 지역 철도 정식 운행계획',
    subtitle: '새 인게임·첨부 운행자료 기반 · 21개 계통·총 356편',
    tables: [manualTable('정식 운행 계통', ['열차 등급', '운행 계통', '열차번호', '운행 횟수'], [
      ['ITX-새마을', '원산 ↔ 청량리', '#5001~#5026', '13회 왕복'],
      ['ITX-새마을', '원산 ↔ 양구 ↔ 청량리', '#5031~#5058', '14회 왕복'],
      ['ITX-새마을', '신의주 ↔ 서울 / 부산', '#5061~#5084', '9회 / 2회 왕복'],
      ['ITX-새마을', '평양 ↔ 원산 / 해주 ↔ 서울', '#5101~#5158', '12회 / 14회 왕복'],
      ['ITX-마음', '샘물동·녕원 ↔ 평양', '#5161~#5200', '7회 / 10회 왕복'],
      ['ITX-마음', '혜산·무산·경흥 ↔ 원산', '#5201~#5258', '각 7·7·9회 왕복'],
      ['ITX-마음', '평양 ↔ 룡연 / 녕원 ↔ 서울', '#5261~#5290', '9회 / 5회 왕복'],
      ['ITX-새마을', '신의주 ↔ 원산 / 샘물동 ↔ 서울', '#5301~#5362', '각 6회 왕복'],
      ['KTX-산천', '서울 ↔ 블라디보스토크', '#8001~#8012', '6회 왕복'],
      ['KTX-산천', '신의주 ↔ 부산 / 서울', '#8021~#8036 / #9001~#9018', '8회 / 9회 왕복'],
      ['KTX-이음', '원산 ↔ 부산', '#9521~#9540', '10회 왕복'],
      ['KTX-산천', '경흥 ↔ 남대구', '#9701~#9716', '8회 왕복'],
      ['KTX-산천', '경흥 ↔ 목포', '#9751~#9764', '7회 왕복']
    ])],
    callouts: [
      'ITX-마음·ITX-새마을은 전 역 정차하며 KTX 통과역도 실제 순서대로 표시됩니다.',
      '역별 도착·출발·통과 시각은 함께 제공되는 전체 시간표에서 확인해 주세요.'
    ]
  }
];
