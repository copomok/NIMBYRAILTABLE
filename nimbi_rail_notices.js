...
지연은 운행 중 서서히 누적됐다가 <strong>일부 회복</strong>되기도 합니다. 그래서 지연 예상 열차가 예상보다 일찍·정시에 도착하기도 하고, 반대로 예상에 없던 소폭 지연이 생기기도 합니다. 같은 열차는 그날 하루 같은 패턴을 유지합니다(매일 조금씩 달라짐).<br><br>
