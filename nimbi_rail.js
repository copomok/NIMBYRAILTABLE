...
gyeongbu:{
  ...
  routes:[
    {color:'#e3b341', stations:[
      {n:'서울',x:202,y:312},{n:'한강로',x:192,y:333},{n:'남안양',x:183,y:358},
      {n:'수원',x:187,y:387},{n:'오산',x:184,y:412},{n:'평택',x:183,y:440},
      {n:'천안',x:207,y:480},{n:'목천',x:222,y:490},{n:'병천',x:235,y:500},
      {n:'북청주',x:243,y:502},{n:'서청주',x:258,y:525},{n:'상당',x:264,y:540},
      {n:'문의',x:255,y:552},{n:'신탄진',x:252,y:576},{n:'회덕',x:249,y:594},
      {n:'대전',x:252,y:612},{n:'판암',x:259,y:627},{n:'세천',x:267,y:642},
      {n:'옥천',x:276,y:660},{n:'이원',x:282,y:675},{n:'심천',x:288,y:688},
      {n:'영동',x:297,y:705},{n:'황간',x:318,y:717},{n:'추풍령',x:339,y:728},
      {n:'봉산',x:360,y:732},{n:'김천',x:380,y:734},{n:'구미',x:407,y:730},
      {n:'약목',x:427,y:742},{n:'서왜관',x:439,y:758},{n:'하빈',x:452,y:772},
      {n:'호림',x:464,y:788},{n:'남대구',x:479,y:807},{n:'경산',x:503,y:814},
      {n:'운문',x:521,y:826},{n:'언양',x:533,y:843},{n:'동양산',x:535,y:860},
      {n:'북부산',x:533,y:876},{n:'동래',x:531,y:892},{n:'부산',x:529,y:912},
    ]},
  ],
},
...
gyeongbuhs:{
  ...
  routes:[
    ...
    {color:'#388bfd', stations:[
      {n:'서울',x:202,y:312},{n:'한강로',x:192,y:333},
      {n:'병목안',x:162,y:358},{n:'수영',x:174,y:379},
      {n:'천안',x:207,y:480},{n:'정안',x:192,y:522},
      {n:'세종',x:207,y:555},{n:'대전',x:252,y:612},
      {n:'산내',x:229,y:630},{n:'영동',x:297,y:705},
      {n:'구미',x:407,y:730},{n:'남대구',x:479,y:807},
      {n:'청도',x:511,y:830},{n:'부산',x:529,y:912},
    ]},
    // 잠실 지선
    {color:'#388bfd', dash:true, stations:[
      {n:'잠실',x:260,y:305},{n:'동탄',x:218,y:430},{n:'천안',x:207,y:480},
    ]},
    // 서인천 지선
    {color:'#388bfd', dash:true, stations:[
      {n:'서인천',x:80,y:350},{n:'수영',x:174,y:379},
    ]},
    // 포항 분기
    {color:'#388bfd', dash:true, stations:[
      {n:'청도',x:511,y:830},{n:'포항',x:580,y:840},
    ]},
    // 창녕 분기
    {color:'#388bfd', dash:true, stations:[
      {n:'부산',x:529,y:912},{n:'창녕',x:430,y:940},
    ]},
  ],
},
...
honam:{
  ...
  routes:[
    {color:'#3fb950', stations:[
      {n:'회덕',x:249,y:594},{n:'서대전',x:234,y:638},
      {n:'남대전',x:219,y:663},{n:'계룡',x:201,y:681},
      {n:'논산',x:187,y:702},{n:'연무',x:180,y:721},
      {n:'여산',x:174,y:740},{n:'봉동',x:165,y:760},
      {n:'전주',x:159,y:780},{n:'중인',x:153,y:802},
      {n:'남김제',x:147,y:822},{n:'신태인',x:141,y:843},
      {n:'정읍',x:135,y:864},{n:'입암',x:129,y:882},
      {n:'북이',x:123,y:898},{n:'장성',x:117,y:915},
      {n:'광주',x:108,y:938},{n:'나산',x:93,y:958},
      {n:'함평',x:81,y:976},{n:'무안',x:70,y:993},
      {n:'도림',x:60,y:1010},{n:'목포',x:49,y:1026},
    ]},
  ],
},
...
jungang:{
  ...
  routes:[
    {color:'#56d0e0', stations:[
      {n:'청량리',x:243,y:312},{n:'중랑',x:264,y:327},
      {n:'도농',x:285,y:345},{n:'덕소',x:306,y:363},
      {n:'양수',x:327,y:379},{n:'양평',x:354,y:393},
      {n:'지정',x:380,y:414},{n:'원주',x:413,y:441},
      {n:'신림',x:425,y:468},{n:'제천',x:431,y:498},
      {n:'매포',x:437,y:522},{n:'단양',x:442,y:546},
      {n:'풍기',x:446,y:570},{n:'영주',x:452,y:600},
      {n:'문수',x:455,y:618},{n:'옹천',x:458,y:636},
      {n:'안동',x:461,y:660},{n:'의성',x:464,y:696},
      {n:'금성',x:467,y:720},{n:'이화',x:470,y:741},
      {n:'화본',x:473,y:759},{n:'신녕',x:476,y:777},
      {n:'영천',x:485,y:801},{n:'건천',x:500,y:814},
    ]},
  ],
},
...
donghae:{
  ...
  routes:[
    {color:'#3fb994', stations:[
      {n:'강릉',x:530,y:312},{n:'남강릉',x:535,y:345},
      {n:'옥계',x:540,y:378},{n:'동해',x:545,y:412},
      {n:'북평',x:548,y:445},{n:'삼척',x:550,y:478},
      {n:'근덕',x:552,y:510},{n:'원덕',x:553,y:542},
      {n:'부구',x:554,y:574},{n:'울진',x:555,y:608},
      {n:'평해',x:556,y:638},{n:'영해',x:556,y:665},
      {n:'영덕',x:555,y:692},{n:'강구',x:553,y:718},
      {n:'청하',x:550,y:742},{n:'포항',x:580,y:770},
      {n:'안강',x:560,y:795},{n:'경주',x:545,y:818},
      {n:'불국사',x:535,y:836},{n:'입실',x:528,y:852},
      {n:'북울산',x:522,y:867},{n:'태화강',x:518,y:882},
      {n:'울주',x:521,y:896},{n:'좌천',x:524,y:910},
      {n:'기장',x:526,y:924},{n:'해운대',x:527,y:937},
      {n:'부산',x:529,y:952},
    ]},
  ],
},
