...
gyeongbuhs:{
  ...
  routes:[
    ...
    {color:'#388bfd', dash:true, stations:[
      {n:'잠실',x:290,y:305},{n:'동탄',x:230,y:450},{n:'천안',x:207,y:484},
    ]},
    // 서인천 지선
    {color:'#388bfd', dash:true, stations:[
      {n:'서인천',x:80,y:362},{n:'수영',x:171,y:379},
    ]},
    // 포항 분기: 남대구에서 분기
    {color:'#388bfd', dash:true, stations:[
      {n:'남대구',x:484,y:810},{n:'포항',x:586,y:562},
    ]},
    // 창녕 분기: 청도에서 분기
    {color:'#388bfd', dash:true, stations:[
      {n:'청도',x:516,y:824},{n:'창녕',x:464,y:840},
    ]},
  ],
},
